...
- Built analytics pipelines using Women’s Premier League datasets  
- Performed EDA, feature engineering & trend analysis  
- Designed reusable data workflows  

### 🚆 Railway Delay Prediction System
- Developed ML model to predict train delays  
- Engineered features to improve prediction accuracy  
- Evaluated using regression/classification metrics  

### 📚 AI Book Recommendation System
- Built collaborative filtering engine (1M+ ratings)  
- Applied cosine similarity for personalized recommendations  
